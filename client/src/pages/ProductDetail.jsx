          ...
          <section className="mt-20">
            ...
            <div>
              ...
              <span>
                ...
                bằng kính bền đẹp, chịu lực tốt. Chất liệu kính chống trầy xước,
                chống bám bẩn nên dễ dàng vệ sinh, lau chùi. Mặt bàn có kiểu
                dáng hình tam giác với các góc bo tròn đẹp mắt, làm tăng thêm vẻ
                mềm mại và tính thẩm mỹ cho sản phẩm. Chân bàn có độ ổn định cao
                Chân bàn được làm từ gỗ beech (gỗ dẻ gai) cứng chắc. Chất liệu
                gỗ đã được xử lý chống mối mọt, chống ẩm mốc và không có mùi khó
                chịu. Khả năng chịu lực cao, chịu được các va đập nên không bị
                biến dạng, cong vênh trong quá trình sử dụng. Chân bàn được
                thiết kế độc đáo với độ cân bằng cao, chống trượt, giúp bàn
                không bị chông chênh, rung lắc khi ngồi. Phù hợp với nhiều phong
                cách nội thất Bàn sofa thời trang Noguchi Home'furni sở hữu
                thiết kế độc đáo và tinh tế, phù hợp với nhiều phong cách nội
                thất khác nhau, từ đơn giản đến sang trọng, cổ điển đến hiện
                đại. Sản phẩm thích hợp sử dụng trong gia đình, các nhà hàng,
                quán cà phê, khách sạn... góp phần tô điểm cho không gian sống
                thêm trang nhã.
              </span>
            </div>
          </section>
